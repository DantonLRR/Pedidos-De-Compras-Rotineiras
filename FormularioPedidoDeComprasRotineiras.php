...
<body>
    ...
    include "Config/php/crud_formulario.php";
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="<?= $USUARIO ?>" id="solicitante" name="solicitante" placeholder="Nome do solicitante" required>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" id="dataSolicitacao" name="dataSolicitacao" value="<?= $hoje ?>" required>
                                            <div class="invalid-feedback">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="item" name="item" placeholder="Nome do item" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="PrecoEstimado">Preço Estimado:</label>
                                            <input type="text" class="form-control" id="PrecoEstimado" name="PrecoEstimado" placeholder="0,00" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="tamanho">Tamanho:</label>
                                            <input type="text" class="form-control" id="tamanho" name="tamanho" value='N/A' placeholder="Tamanho">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="unidade" name="unidade" value='N/A' placeholder="Unidade">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
